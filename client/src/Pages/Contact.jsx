  ...
  return (<>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              <p>📧 Email: kumarikajal.2223k@gmail.com</p>
        ...
        <div className="flex gap-5 mt-6">
            <a href='https://www.linkedin.com/in/kajal-kumari-07b703332' className="flex items-center gap-2 px-5 py-2 rounded-full bg-blue-600 hover:bg-blue-700 transition hover:scale-110">
                <FaLinkedin /> LinkedIn
            </a>
            <a  href='https://github.com/kumari-Kajal123' className="flex items-center gap-2 px-5 py-2 rounded-full bg-gray-800 hover:bg-black transition hover:scale-110">
                <FaGithub /> GitHub
            </a>
